...
# Bitfile with forwarding program (build original bitstream)
forwarding_bit = tester_module.build_bitstream( "forwarding_iosystem",["xdc"],hdl_files, implement_build =True, 
	...
	generics = [ \
		"TEXT_MEMORY_FILENAME=buttoncount_text.mem",
		"DATA_MEMORY_FILENAME=forwarding_iosystem_data.mem",
		"DEBOUNCE_DELAY_US=150",
	])

# Update bitfile with the "move_char" program
move_char_bit = tester_module.update_bitstream_mem( "move_char_text.mem", "move_char_data.mem", 
...
def main():
	...
	lab_test.add_test_module(move_char_bit)
	...
	message.append('='*80)
	# {}
	bitfile_path = lab_test.submission_lab_path / "move_char.bit"
	message.append(f"NOTE: You should test the bitfile \"move_char.bit\" generated by the passoff script.")
	...
	message.append("")
	message.append(f"  python3 ../resources/openocd.py {bitfile_path}")
	message.append("")
	message.append('='*80)
	message.append('')
